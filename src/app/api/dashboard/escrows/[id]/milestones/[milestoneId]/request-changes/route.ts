...
export async function POST(
  ...
  if (!isMockApiEnabled) {
    return proxyApiRequest(request, `/api/dashboard/escrows/${id}/milestones/${milestoneId}/request-changes`);
  }
  return NextResponse.json({ success: true, escrowId: id, milestoneId: Number(milestoneId) });
}
